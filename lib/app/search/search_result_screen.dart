...
import 'package:soul_sync/app/search/search_result_screen_v2.dart';

import '../../custom_view/player_widget/animated_screen_transition.dart';
import '../../custom_view/player_widget/loader.dart';
import '../../custom_view/player_widget/search_related_widgets.dart';
...
class SearchResultScreen extends StatelessWidget {
  ...
  NavigationRailDestination railDestination(String label) {
    return NavigationRailDestination(
      ...
      label: RotatedBox(
        quarterTurns: -1,
        child: CustomTextView(label.toLowerCase().removeAllWhitespace.tr),
      ),
    );
  }
}
