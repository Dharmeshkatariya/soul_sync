              ...
              CustomExpansionTile(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    subtitle: CustomTextView("languageDes".tr,
                        style: Theme.of(context).textTheme.bodyMedium),
                    trailing: Obx(
                      () => DropdownButton(
                  ...
                  if (!isDesktop)
                    ListTile(
                      ...
                      subtitle: CustomTextView("playerUiDes".tr,
                          style: Theme.of(context).textTheme.bodyMedium),
                      trailing: Obx(
                        () => DropdownButton(
                          dropdownColor: Theme.of(context).cardColor,
                          ...
                          items: [
                            DropdownMenuItem(
                                value: 0, child: CustomTextView("standard".tr)),
                            DropdownMenuItem(
                              value: 1,
                  ...
                  if (!isDesktop)
                    ListTile(
                        ...
                        subtitle: CustomTextView("enableBottomNavDes".tr,
                            style: Theme.of(context).textTheme.bodyMedium),
                        trailing: Obx(
                          () => CustSwitch(
                  ...
                  ListTile(
                      ...
                      subtitle: CustomTextView("disableTransitionAnimationDes".tr,
                          style: Theme.of(context).textTheme.bodyMedium),
                      trailing: Obx(
                        () => CustSwitch(
                            value: settingsController
                  ...
                  ListTile(
                      ...
                      subtitle: CustomTextView("enableSlidableActionDes".tr,
                          style: Theme.of(context).textTheme.bodyMedium),
                      trailing: Obx(
                        () => CustSwitch(
                            value:
              ...
              CustomExpansionTile(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      subtitle: CustomTextView("homeContentCountDes".tr,
                          style: Theme.of(context).textTheme.bodyMedium),
                      trailing: Obx(
                        () => DropdownButton(
                          dropdownColor: Theme.of(context).cardColor,
                          ...
                          items: ([3, 5, 7, 9, 11])
                              .map((e) =>
                                  DropdownMenuItem(value: e, child: CustomTextView("$e")))
                              .toList(),
                    ...
                    ListTile(
                        ...
                        subtitle: CustomTextView("cacheHomeScreenDataDes".tr,
                            style: Theme.of(context).textTheme.bodyMedium),
                        trailing: Obx(
                          () => CustSwitch(
                              value:
                    ...
                    ListTile(
                      ...
                      subtitle: CustomTextView("linkPipedDes".tr,
                          style: Theme.of(context).textTheme.bodyMedium),
                      trailing: TextButton(
                          child: Obx(() => CustomTextView(
                    ...
                    Obx(() => (settingsController.isLinkedWithPiped.isTrue)
                        ? ListTile(
                            ...
                            title: CustomTextView("resetblacklistedplaylist".tr),
                            subtitle: CustomTextView("resetblacklistedplaylistDes".tr,
                                style: Theme.of(context).textTheme.bodyMedium),
                            trailing: TextButton(
                                child: CustomTextView(
                                  "reset".tr,
              ...
              CustomExpansionTile(
                ...
                children: [
                  ListTile(
                    ...
                    subtitle: CustomTextView("streamingQualityDes".tr,
                        style: Theme.of(context).textTheme.bodyMedium),
                    trailing: Obx(
                      () => DropdownButton(
                        dropdownColor: Theme.of(context).cardColor,
                        ...
                        items: [
                          DropdownMenuItem(
                              value: AudioQuality.Low, child: CustomTextView("low".tr)),
                          DropdownMenuItem(
                  ...
                  if (GetPlatform.isAndroid)
                    ListTile(
                        ...
                        subtitle: CustomTextView("loudnessNormalizationDes".tr,
                            style: Theme.of(context).textTheme.bodyMedium),
                        trailing: Obx(
                          () => CustSwitch(
                              value: settingsController
                  ...
                  if (!isDesktop)
                    ListTile(
                        ...
                        subtitle: CustomTextView("cacheSongsDes".tr,
                            style: Theme.of(context).textTheme.bodyMedium),
                        trailing: Obx(
                          () => CustSwitch(
                  ...
                  if (!isDesktop)
                    ListTile(
                        ...
                        subtitle: CustomTextView("skipSilenceDes".tr,
                            style: Theme.of(context).textTheme.bodyMedium),
                        trailing: Obx(
                          () => CustSwitch(
                              value:
                  ...
                  if (isDesktop)
                    ListTile(
                        ...
                        subtitle: CustomTextView("backgroundPlayDes".tr,
                            style: Theme.of(context).textTheme.bodyMedium),
                        trailing: Obx(
                          () => CustSwitch(
                              value: settingsController
                  ...
                  ListTile(
                      ...
                      subtitle: CustomTextView("keepScreenOnWhilePlayingDes".tr,
                          style: Theme.of(context).textTheme.bodyMedium),
                      trailing: Obx(
                        () => CustSwitch(
                  ...
                  ListTile(
                      ...
                      subtitle: CustomTextView("restoreLastPlaybackSessionDes".tr,
                          style: Theme.of(context).textTheme.bodyMedium),
                      trailing: Obx(
                        () => CustSwitch(
                            value:
                  ...
                  ListTile(
                    ...
                    subtitle: CustomTextView("autoOpenPlayerDes".tr,
                        style: Theme.of(context).textTheme.bodyMedium),
                    trailing: Obx(
                      () => CustSwitch(
                  ...
                  if (!isDesktop)
                    ListTile(
                      ...
                      subtitle: CustomTextView("equalizerDes".tr,
                          style: Theme.of(context).textTheme.bodyMedium),
                      onTap: () async {
                        try {
                  ...
                  if (!isDesktop)
                    ListTile(
                      ...
                      subtitle: CustomTextView("stopMusicOnTaskClearDes".tr,
                          style: Theme.of(context).textTheme.bodyMedium),
                      trailing: Obx(
                        () => CustSwitch(
                            value: settingsController
                      ...
                      ? Obx(
                          () => ListTile(
                            ...
                            onTap: settingsController
                                ...
                                : null,
                            subtitle: Obx(() => RichCustomTextView(
                                  text: TextSpan(
                                    text:
              ...
              CustomExpansionTile(
                ...
                children: [
                  ListTile(
                    ...
                    subtitle: CustomTextView("autoDownFavSongDes".tr,
                        style: Theme.of(context).textTheme.bodyMedium),
                    trailing: Obx(
                      () => CustSwitch(
                          value: settingsController
                  ...
                  ListTile(
                    ...
                    subtitle: CustomTextView("downloadingFormatDes".tr,
                        style: Theme.of(context).textTheme.bodyMedium),
                    trailing: Obx(
                      () => DropdownButton(
                        dropdownColor: Theme.of(context).cardColor,
                        ...
                        items: const [
                          DropdownMenuItem(
                              value: "opus", child: CustomTextView("Opus/Ogg")),
                          DropdownMenuItem(
                            value: "m4a",
                  ...
                  SizedBox(
                    child: Column(
                      children: [
                        ...
                        CustomTextView(settingsController.currentVersion,
