...
import 'package:soul_sync/custom_view/player_widget/playlist_export_dialog.dart';
import 'package:soul_sync/custom_view/player_widget/sort_widget.dart';
                        ...
                        Expanded(
                          child: Obx(
                                ...
                                Marquee(
                                  ...
                                  id: "${playlistController.playlist.value.title
                                      .hashCode.toString()}_appbar",
                      ...
                      child: Obx(
                            ...
                            ScrollConfiguration(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount: playlistController.songList
                                    .isEmpty ||
                                ...
                                itemBuilder: (_, index) {
                                                ...
                                                IconButton(
                                                  ...
                                                  onPressed: () {
                                                    ...
                                                    if (content
                                                        .isPipedPlaylist) {
                                                      Share.share(
                                                        "https://piped.video/playlist?list=${content
                                                            .playlistId}",
                                                      );
                                                    } else {
                                      ...
                                      child: Padding(
                                        ...
                                        child: Obx(
                                              ...
                                              SortWidget(
                                                ...
                                                onSort: playlistController
                                                    .onSort,
                                                onSearch: playlistController
                                                    .onSearch,
                                                onSearchClose:
                                                playlistController
                                                    .onSearchClose,
                                  ...
                                  return Padding(
                                    ...
                                    child: SongListTile(
                                      ...
                                      song: playlistController.songList[index -
                                          3],
