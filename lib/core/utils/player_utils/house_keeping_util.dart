...
class HousekeepingUtil {
  // Private constructor
  HousekeepingUtil._internal();

  // Singleton instance
  static final HousekeepingUtil _instance = HousekeepingUtil._internal();

  // Factory constructor to return the same instance
  factory HousekeepingUtil() {
    return _instance;
  }

  // Public getter to access the instance
  static HousekeepingUtil get instance => _instance;

  static void startHouseKeeping() {
    removeExpiredSongsUrlFromDb();
  }

  static Future<void> removeExpiredSongsUrlFromDb() async {
    try {
      ...
      for (var i = 0; i < songsUrlCacheKeysList.length; i++) {
        ...
        if (streamData == null ||
            ...
            (streamData != null &&
                isExpired(url: streamData['url'] as String))) {
  ...
  static Future<void> removeDeletedOfflineSongsFromDb() async {
