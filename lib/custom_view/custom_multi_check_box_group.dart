...
class CustomMultiCheckBoxGroup<T> extends StatelessWidget {
  CustomMultiCheckBoxGroup({
...
class _CustomCheckbox<T> extends StatelessWidget {
  _CustomCheckbox({
    required this.value,
